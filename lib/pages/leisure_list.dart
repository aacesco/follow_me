...
class LeisureList extends StatefulWidget {
  const LeisureList({super.key});

  @override
  State<LeisureList> createState() => _LeisureListState();
}

class _LeisureListState extends State<LeisureList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_scrollController.hasClients) {
        _scrollController.jumpTo(_scrollPositionController.getScrollPosition(AppConstants.LEISURE));
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    eventsRepo.searchEvents(AppConstants.LEISURE);
  ...
  void _saveScrollPosition() {
    print("_saveScrollPosition " + AppConstants.LEISURE + " offset " + _scrollController.offset.toString());
    _scrollPositionController.saveScrollPosition(_scrollController.offset, AppConstants.LEISURE);
  }
}
